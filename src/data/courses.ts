...
export const courses: Course[] = [
  ...
  },
  {
    ...
    duration: "8h 45m",
    lectureCount: 32,
    description: "Are you constantly seeking approval from others? Do you change who you are depending on who you're around? This program helps you spot the approval bids, understand why you make them, and build the internal validation that frees you from needing others to tell you you're okay.",
  ...
  },
  {
    ...
    duration: "5h 15m",
    lectureCount: 20,
    description: "Covert contracts are the unspoken deals Nice Guys make: 'If I do X, you should do Y.' They're the source of resentment, frustration, and broken relationships. This program teaches you to identify your covert contracts, understand why you create them, and replace them with direct communication and genuine giving.",
  ...
  },
  {
    ...
    duration: "6h 45m",
    lectureCount: 26,
    description: "Most Nice Guys settle in dating because they believe they can't do better, or they chase women hoping to earn love through performance. This program flips the script: you'll define your standards, build genuine confidence, and learn to date from a place of abundance rather than desperation.",
