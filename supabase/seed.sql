...
VALUES
  ...
  ('00000000-0000-0000-0000-000000000002', 'The Approval Addiction Recovery Course', 'approval-addiction-recovery-course', 'Michael Zick', 'nice-guy-recovery', 'Beginner', 197, 147, 4.8, 278, 987, '8h 45m', 32, 'Are you constantly seeking approval from others? Do you change who you are depending on who you''re around? This course helps you spot the approval bids, understand why you make them, and build the internal validation that frees you from needing others to tell you you''re okay.', 'Spot the bid for approval and break the addiction cycle.', 'https://images.unsplash.com/photo-1470071459604-3b5ec3a7fe05', true, false, 'December 2025', 'English', ARRAY['Approval Addiction', 'Self-Validation', 'Awareness', 'Covert Contracts', 'Recovery'], ARRAY['Recognize your approval-seeking patterns in real time', 'Understand the approval addiction recovery loop', 'Cancel covert contracts that keep you stuck', 'Build internal validation and self-trust', 'Navigate discomfort without reverting to old patterns'], true),
...
VALUES (
  ...
  'How To Speak Womanese And Handle Conflict Like A Champ',
  'how-to-speak-womanese-and-handle-conflict-like-a-champ',
  'Michael Zick',
  'relationship-skills',
  'All Levels',
